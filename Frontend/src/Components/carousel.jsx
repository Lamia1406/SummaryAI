...
export default function Carousel({isVisibleLeft, img, title, content,isVisibleRight, line_id, onClickLeft, onClickRight}){
    return (
        <div className="carousel">
           <CarouselTop arrow_left ={<ArrowLeft isVisible= {isVisibleLeft}  onClick={onClickLeft}/>} 
           feature = {<Feature img={img} title= {title} content={content}/>}  
           arrow_right ={<ArrowRight isVisible= {isVisibleRight} onClick={onClickRight}/>} />
